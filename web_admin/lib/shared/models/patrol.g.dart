...
AssignedUser _$AssignedUserFromJson(Map<String, dynamic> json) =>
    AssignedUser(id: (json['id'] as num).toInt(), name: json['name'] as String);

Map<String, dynamic> _$AssignedUserToJson(AssignedUser instance) =>
    <String, dynamic>{'id': instance.id, 'name': instance.name};

AssignedSite _$AssignedSiteFromJson(Map<String, dynamic> json) =>
    AssignedSite(id: (json['id'] as num).toInt(), name: json['name'] as String);
